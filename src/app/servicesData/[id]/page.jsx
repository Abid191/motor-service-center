import { singleServiceData } from '@/Services/Get-All-Api/Api'
import Image from 'next/image'
import Link from 'next/link'
import React from 'react'

export default async function ServiceData({ params }) {

    const motorData = await singleServiceData(params.id)

    const { title, description, img, price, facility, _id } = motorData.singleService
